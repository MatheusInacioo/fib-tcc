        ...
        >
            <div class="form-row flex mb-5">
                <div class="form-field flex flex-col mr-6">
                    <span class="font-medium text-lg ml-1 mb-2">Nome da empresa</span>
                    <input
                        v-model="form.name"
                        class="border-gray-300 w-340 rounded-xl"
                        type="text"
                        name="name"
                        id="name"
                ...
                <div class="form-field flex flex-col mr-6">
                    <span class="font-medium text-lg ml-1 mb-2">CNPJ</span>
                    <input
                        v-model="form.cnpj"
                        class="border-gray-300 w-340 rounded-xl"
                        type="text"
                ...
                <div class="form-field flex flex-col mr-6">
                    <span class="font-medium text-lg ml-1 mb-2">Email da empresa</span>
                    <input
                        v-model="form.email"
                        class="border-gray-300 w-340 rounded-xl"
                        type="email"
                ...
                <div class="form-field flex flex-col mr-6">
                    <span class="font-medium text-lg ml-1 mb-2">Endereço</span>
                    <input
            ...
            <div class="form-row flex mb-5">
                <div class="form-field flex flex-col mr-6">
                    <span class="font-medium text-lg ml-1 mb-2">Telefone da empresa</span>
                    <input
                        v-model="form.phone"
                        class="border-gray-300 w-340 rounded-xl"
                        type="text"
                ...
                <div class="form-field flex flex-col mr-6">
                    <span class="font-medium text-lg ml-1 mb-2">Nome do responsável</span>
                    <input
                ...
                <div class="form-field flex flex-col mr-6">
                    <span class="font-medium text-lg ml-1 mb-2">Celular do responsável</span>
                    <input
                ...
                <div class="form-field flex flex-col mr-6">
                    <span class="font-medium text-lg ml-1 mb-2">Segmento de atuação</span>
                    <input
