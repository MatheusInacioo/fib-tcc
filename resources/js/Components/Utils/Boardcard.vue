<template>
    <div
        class="boardcard flex justify-center min-h-28 bg-white rounded-lg shadow-lg hover:scale-105 transition-all mb-4 p-2"
    >
        <div 
            v-if="isLoading" 
            class="flex justify-center items-center"
        >
            <i class="bx bx-loader-alt animate-spin text-xl web:mr-2 text-primary"></i>
        ...
        >
            ...
            >
                ...
                <div class="flex">
                    <p class="mr-2 p-1 max-w-24 text-xs font-semibold bg-blue-500 rounded-md text-white uppercase">{{ item.type_label }}</p>
